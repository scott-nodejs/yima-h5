      ...
      <div class="upload-container">
        <div class="el-upload el-upload--text">
          <div class="el-upload-dragger"><i class="el-icon-upload"></i>
            <div v-if="item.imgs[0].src" class="image-preview" :style="{ backgroundImage: 'url(' + item.imgs[0].src + ')' }">
            ...
            reader.onloadend = () => {
              ...
              img.onload = () => {
                ...
                if (invalide) {
                  ...
                  this.item.imgs[0].width = 30
                  this.item.imgs[0].height = 30
                  const data = { img: img.src }
                  this.uploadImg (data).then(res => {
                    // 传入success回调里的数据就是富文本编辑器里插入图片的src的值
                    this.item.imgs[0].src = `${this.baseUrl}/${res.msg}`
