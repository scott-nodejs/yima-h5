...
<script>
  ...
  import appSidebar from 'core/yima/layout/sidebar.vue'
  import appToolbar from 'core/yima/layout/toolbar.vue'
  import appOpt from 'core/yima/layout/option.vue'
  ...
  export default {
    ...
    methods: {
      ...
      showPreview() {
          ...
          this.previewUrl = 'http://yima.hazer.top/h5/#/subpkg/pages/index/index?preview=1&uid='+uid;
